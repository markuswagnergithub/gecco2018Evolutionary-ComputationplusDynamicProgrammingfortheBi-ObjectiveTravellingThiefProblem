...
import au.edu.adelaide.sc.ttp.gui.Displayer;

public class TtpIbea<S extends Solution<?>> implements Algorithm<List<S>> {
	private static final long serialVersionUID = 4025781521130564288L;
	 ...
	 * Constructor
	 */
	public TtpIbea(Problem<S> problem, int populationSize, int archiveSize, int maxEvaluations,
	...
	public void run() {
		...
		Displayer.show(solutionSet, evaluations);
